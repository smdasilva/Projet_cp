...
\hypersetup{
    pdfauthor   = {Clément Badiola, Alexandre Perrot, Samuel Da Silva, Reda Liazidi},% 
...
\author{Clément~\textsc{Badiola} \and Alexandre~\textsc{Perrot} \and Samuel~\textsc{Da~Silva} \and Reda~\textsc{Liazidi}  \and \\
